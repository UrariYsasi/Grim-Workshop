...
std::vector<glm::vec2> PoissonDiskGenerator::Generate(const glm::vec2& initialPoint, double innerRadius, double outerRadius, int precision, const grim::graphics::Rect& zone)
{
