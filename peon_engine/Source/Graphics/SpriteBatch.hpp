...
public:
    ...
    */
    void AddSprite(const glm::vec3& position, const glm::vec3& rotation, const glm::vec3& scale, grim::graphics::Sprite* sprite);
...
private:
    ...
    */
    void AddVertex(const grim::graphics::Vertex& vertex);
...
private:
    ...
    */
    std::vector<grim::graphics::Vertex> m_vertexDataBuffer;
