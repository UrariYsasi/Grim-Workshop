    ...
    m_mousePosition(0, 0)
{
    ...
    std::fill(m_downKeys, m_currentKeys + MAX_KEYBOARD_KEYS, false);
    std::fill(m_upKeys, m_currentKeys + MAX_KEYBOARD_KEYS, false);
    std::fill(m_currentMouseButtons, m_currentKeys + MAX_MOUSE_BUTTONS, false);
    std::fill(m_downMouseButtons, m_currentKeys + MAX_MOUSE_BUTTONS, false);
    std::fill(m_upMouseButtons, m_currentKeys + MAX_MOUSE_BUTTONS, false);
}
